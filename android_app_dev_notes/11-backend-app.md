# Backend App for Product Management using `Sqlite + Sequelize ORM + Express JS`

* API endpoints (summary):
  * GET / — health check
  * GET /products — list products
  * GET /products/:id — get product by id
  * POST /products — create product (JSON body: { name, description, stock, price })
  * PUT /products/:id — update product
  * DELETE /products/:id — delete product
## 1. Initialize a folder and install dependencies:
```bash
mkdir ProductBackend
cd ProductBackend
npm init -y
